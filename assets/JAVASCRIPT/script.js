...
// déclaration du canvas dans lequel le pendu apparaît
const canvas = document.getElementById("canvas");
// déclaration du texte (win/lose)
...
//déclaration du score win et score count(défaite) , déclaration de la variable du mot "choisi" 
let winCount = 0;
let count = 0;
...
const generateWord = (optionValue) => {
  ...
  // désactivation de la div letterContainer au chargement du jeu ( ce qui laisse apparître le menu utilisateur)
  ...
  //afficher toutes les lettres en tant que span (cache le mot)
  userInputSection.innerHTML = displayItem;
};

//Démarrage, les "counts" sont remis à zéro(affichage quand la nouvelle page charge, quand le bouton newgame a été activé)
const initializer = () => {
  winCount = 0;
  count = 0;

  //efface tout le contenu,puis cache le tableau des lettres et le bouton nouvelle partie
